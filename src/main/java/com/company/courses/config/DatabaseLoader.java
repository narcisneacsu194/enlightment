...
public class DatabaseLoader implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        bytes = extractBytes("src/main/resources/static/img/java.png");
        ...
        IntStream.range(0, 6).forEach(value ->{
            ...
            try {
                byte[] bytes2 = extractBytes("src/main/resources/static/img/placeholder.jpg");
                user.setAvatar(bytes2);
            }catch(IOException ioe){
                ioe.printStackTrace();
            }

            Subject subject2 = subjects.get(value);
            user.addCreatedSubject(subject2);
            subject2.setTeacher(user);
...
//
//        degree.addUser(user2);
//        user2.addDegree(degree);
//
//        subjectDao.save(subject);
