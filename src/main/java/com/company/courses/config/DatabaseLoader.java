...
public class DatabaseLoader implements ApplicationRunner{
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        User user2 = new User();
        user2.setUsername("narcisneacsu194");
        user2.setPassword("password");
        user2.encodePassword();
        user2.setDescription("Huge Geek");
        ...
        user2.setDateOfRegistration(Instant.now());

        byte[] bytes = extractBytes("src/main/resources/static/img/img-large2.jpg");
        user2.setAvatar(bytes);
